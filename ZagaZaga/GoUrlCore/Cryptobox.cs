...
namespace ZagaZaga.GoUrlCore
{
    ...
    {
        private static readonly string[] CryptoboxCoins = { "bitcoin", "litecoin", "dogecoin", "dash", "speedcoin", "reddcoin", "potcoin", "feathercoin", "vertcoin", "bitcoincash", "peercoin", "monetaryunit" };
    ...
    {
        private static readonly string[] CryptoboxCoins = { "bitcoin", "litecoin", "bitcoincash", "dogecoin", "dash", "speedcoin", "reddcoin", "potcoin", "feathercoin", "vertcoin", "peercoin", "monetaryunit" };
